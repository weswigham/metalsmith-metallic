    ...
    return function (files, metalsmith, done) {
        ...
        Object.keys(files).forEach(function (file) {
            ...
            while (end.test(remainder)) {
                ...
                var fencePrefixLength = ends[0].length - (ends[2] ? ends[2].length : 0);
                var leadingWhitespaceLength = ends[1] ? ends[1].length : 0;
                var nextPos = pos + endpos + fencePrefixLength - leadingWhitespaceLength;
